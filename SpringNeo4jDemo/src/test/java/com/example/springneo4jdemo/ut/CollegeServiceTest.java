 ...
 private CollegeServiceImp collegeService;
    ...
    public void successCollegeaddDepartmentTest() throws Exception {
        ...
        collegePayLoadDTO.getDepartmentList().forEach(departmentPayLoadDTO -> {
            Mockito.when(departmentRepository.findByDepartmentName(departmentPayLoadDTO.getDepartmentName())).thenReturn(Department.builder().departmentName(departmentPayLoadDTO.getDepartmentName()).build());
